...
namespace eStore.Controllers
{
    public class OrdersController : Controller
    {
        ...
        //public OrdersController(FUFlowerBouquetManagementV4Context context)
        //{
        //    _context = context;
        //}

        IOrderRepo _ordRepo = new OrderRepo();
        // GET: Orders
        public IActionResult Index()
        {
            return View(_ordRepo.GetOrders());
        }
        ...
        //    }
        //    ViewData["CustomerId"] = new SelectList(_context.Customers, "CustomerId", "City", order.CustomerId);
        //    return View(order);
        //}
