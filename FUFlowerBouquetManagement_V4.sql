USE [master]
GO
/****** Object:  Database [FUFlowerBouquetManagementV4]    Script Date: 8/7/2023 7:15:36 AM ******/
CREATE DATABASE [FUFlowerBouquetManagementV4]
GO
USE [FUFlowerBouquetManagementV4]
GO
/****** Object:  User [sa1]    Script Date: 8/7/2023 7:15:37 AM ******/
CREATE USER [sa1] FOR LOGIN [sa1] WITH DEFAULT_SCHEMA=[dbo]
GO
/****** Object:  Table [dbo].[Category]    Script Date: 8/7/2023 7:15:37 AM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[Customer]    Script Date: 8/7/2023 7:15:37 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[FlowerBouquet]    Script Date: 8/7/2023 7:15:37 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Order]    Script Date: 8/7/2023 7:15:37 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[OrderDetail]    Script Date: 8/7/2023 7:15:37 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Supplier]    Script Date: 8/7/2023 7:15:37 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
INSERT [dbo].[Customer] ([CustomerID], [Email], [CustomerName], [City], [Country], [Password], [Birthday], [CustomerStatus]) VALUES (2, N'StevenAllanSpielber@fuflowerbouquetsystem.com', N'Steven Allan Spielber', N'HCM', N'Viet Nam', N'1', CAST(N'1999-05-05' AS Date), 1)
GO
INSERT [dbo].[Customer] ([CustomerID], [Email], [CustomerName], [City], [Country], [Password], [Birthday], [CustomerStatus]) VALUES (3, N'RobertCapshaw@fuflowerbouquetsystem.com', N'Robert Capshaw', N'London', N'UK', N'1', CAST(N'1988-05-09' AS Date), 1)
GO
...
GO
INSERT [dbo].[FlowerBouquet] ([FlowerBouquetID], [CategoryID], [FlowerBouquetName], [Description], [UnitPrice], [UnitsInStock], [FlowerBouquetStatus], [SupplierID], [Morphology]) VALUES (1, 1, N'A New Day', N'Flowers to put a smile on their face. Let them know that you''re thinking of them with this fun petite collection of flowers and foliage to send same day. ', 100.0000, 10, 1, 1, NULL)
GO
INSERT [dbo].[FlowerBouquet] ([FlowerBouquetID], [CategoryID], [FlowerBouquetName], [Description], [UnitPrice], [UnitsInStock], [FlowerBouquetStatus], [SupplierID], [Morphology]) VALUES (2, 1, N'Hello', N'Say hello in style with this fabulous hand-tied.', 120.0000, 10, 1, 2, NULL)
GO
...
GO
INSERT [dbo].[FlowerBouquet] ([FlowerBouquetID], [CategoryID], [FlowerBouquetName], [Description], [UnitPrice], [UnitsInStock], [FlowerBouquetStatus], [SupplierID], [Morphology]) VALUES (5, 3, N'Mother''s Day', N'Let the experts work their magic with a unique Mother’s Day gift.', 160.0000, 5, 1, 1, NULL)
GO
...
GO
INSERT [dbo].[Order] ([OrderID], [CustomerID], [OrderDate], [ShippedDate], [Total], [OrderStatus]) VALUES (4002, 1, CAST(N'2023-04-29T00:00:00.000' AS DateTime), CAST(N'2023-04-30T00:00:00.000' AS DateTime), 510.0000, N'1         ')
GO
